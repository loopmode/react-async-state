...
var AsyncState = function (_Component) {
    ...
    function AsyncState() {
        ...
        return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_ref = AsyncState.__proto__ || Object.getPrototypeOf(AsyncState)).call.apply(_ref, [this].concat(args))), _this), _this.ownProps = ['successDuration', 'errorDuration', 'successClass', 'successProps', 'errorClass', 'errorProps', 'children', 'initialPending', 'pendingProp', 'pendingGroupProp', 'group', 'trigger', 'rejectResolvedErrors', 'onPending', 'onFinished', 'onSuccess', 'onSuccessEnd', 'onError', 'onErrorEnd'], _this.state = {
    ...
    (0, _createClass3.default)(AsyncState, [{
        ...
        value: function createChildProps() {
            ...
            var _props = this.props,
                ...
                ownProps = (0, _objectWithoutProperties3.default)(_props, ['successClass', 'successProps', 'errorClass', 'errorProps', 'trigger']);
            ...
            var propagatedProps = Object.keys(ownProps).reduce(function (result, key) {
                if (_this2.ownProps.includes(key)) return result;
